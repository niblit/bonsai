...
use crate::{board::BoardBackend, kind::Kind, located_piece::{self, LocatedPiece}, piece::Piece, ply::Ply};
...
pub fn generate_pseudo_legal_moves(
    ...
    assert_eq!(backend.get(what_to_move.position()), Some(what_to_move.piece()));
